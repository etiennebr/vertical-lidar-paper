...
pa + pb + pc
```
After testing it, it seems that the third transformation is ineffective. 
The areas that are heterogenuous are generally not fixed.
...
```{r}
# The maximum variance ratio should 4
