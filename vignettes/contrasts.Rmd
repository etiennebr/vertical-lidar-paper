...
```{r}
knitr::include_graphics("figure/fig-sp-combined.svg")
```
...
```{r}
knitr::include_graphics("figure/fig-glm-cc.svg")
```
...
```{r}
knitr::include_graphics("figure/fig-cc.svg")
```
...
```{r}
knitr::include_graphics("figure/fig-age.svg")
```
...
```{r}
knitr::include_graphics("figure/fig-age2.svg")
```
