...
cap <- paste(
  ...
  "The functions are transformed to correct for heteroscedasticity.",
...
pap <- wave_long %>%
  ...
  ggplot(aes(x = height / 40, y = median, group = interaction(dominant_species, crown_closure, age_class))) +
  ...
  labs(caption = wrapper(cap, 80))

ggsave("figure/appendix.pdf", pap + theme_pub(10), width = 6, height = 22, units = "in")
```
