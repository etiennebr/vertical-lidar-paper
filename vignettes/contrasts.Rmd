...
psp <- wave_long %>% 
  ...
  scale_x_continuous("Stand height", limits = c(0, 1), breaks = 1:2/2, expand = c(0, 0)) +
...
papu <- wl %>% 
  ...
  scale_y_continuous("Density of LiDAR returns", breaks = c(0:2) / 10, expand = c(0, 0)) +
  scale_x_continuous("Stand height", limits = c(0, 1), breaks = 1:2/2) +
  geom_text(data = wl %>% 
