...
[note that the abstract is now 275 word, it should be 250 max]
...
reflective material by sending laser pulses through the canopy. 
Studying the vertical distribution of LiDAR returns across varying stand conditions is difficult because the data has many dimensions.
We examined the 
...
stable across different surveys. Nonetheless, the full model (Equation
...
quantile rather than the highest return could reduce this effect and improve model performance.
