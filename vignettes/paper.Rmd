...
would increase the potential area where the method could be applied while reducing
...
that generally reduces the interpretability of results. However, a novel method
called the graphical test of significance [@myllymaki_mrkvicka19;@mrkvicka_etal19] 
allows for a visual understanding of functional data---such as the vertical
distribution of LiDAR returns. It provides a framework to perform non-parametric
tests to compare a continuous function (i.e. the vertical distribution of LiDAR
returns) against categorical and continuous variables. To our knowledge, it is
the first time the method is used in ecology or remote sensing, although it was
recently used in econometric [@mrkvicka_etal20].
...
that the first and last returns were more dispersed in Birch (*Betula* spp.) stands
