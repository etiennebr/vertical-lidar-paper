...
removing the studied variable from the full model (Equation \@ref(eq:full)),
...
left-out $\beta$ in \@ref(eq:species)--\@ref(eq:age). We also summarized the differences by
...
magnitude. Older stands vertical distribution were negatively
affected by age below 28 and 23% of stand height for 90 and 120 years of age,
respectively. Overall, the differences in the vertical distribution of LiDAR
