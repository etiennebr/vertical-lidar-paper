...
would increase the potential area where the method could be used while lowering
the costs of acquisition. The species information could then be used for
...
visual understanding of functional data---such as the vertical distribution of
...
time the method is used in ecology or remote sensing, although it was recently
used in econometric [@mrkvicka_etal20].
