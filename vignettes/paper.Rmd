...
To our knowledge, it is the first time the method is used in ecology or remote
sensing, although similar graphical tests have been used in
economical applications [@mrkvicka_etal20], and similar non-parametric tests 
have been used in neuroimaging (Winkler et al., 2014).
