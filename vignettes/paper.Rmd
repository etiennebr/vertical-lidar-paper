...
\begin{equation}
d(h) = \beta_0(h) +X_{cc}\cdot\beta_{cc}(h) +X_{age}\cdot\beta_{age}(h) +\varepsilon(h)    (\#eq:species)
\end{equation}

\begin{equation}
d(h) = \beta_0(h) +X_{sp}\cdot\beta_{sp}(h) +X_{age}\cdot\beta_{age}(h) +\varepsilon(h)   (\#eq:cc)
\end{equation}

\begin{equation}
d(h) = \beta_0(h) +X_{sp}\cdot\beta_{sp}(h) +X_{cc}\cdot\beta_{cc}(h) +\varepsilon(h)     (\#eq:age)
\end{equation}
