...
`r ifelse(is_docx(), "\t$(\\#eq:species)$\t$(\\#eq:cc)$\t$(\\#eq:age)$", "")`
...
displayed a small concentration of returns at 33–44% of stand height and 
a small decrease below 23% of stand height.
